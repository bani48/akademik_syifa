    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['nip'] == "" || $_REQUEST['admin'] == ""){
                ...
                header("Location: ./admin.php?page=usr&act=add");
                die();
            } else {
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" >
                            ...
                            <!--input id="nip" type="text" class="validate" name="nip" required-->
                             <select id="nip" type="text" class="validate" name="nip" >
                                <option></option> 
                                <?php
                                    $mhs=mysqli_query($config,"SELECT * FROM mahasiswa");
                                    while($dt=mysqli_fetch_array($mhs)){
                                        echo '<option value="'.$dt['id_mahasiswa'].'">'.$dt['id_mahasiswa'].'-'.$dt['nama'].'</option>';
                                    }
                                ?>
                                <option>___________</option>
                                <?php
                                    $mhs=mysqli_query($config,"SELECT * FROM dosen");
                                    while($dt=mysqli_fetch_array($mhs)){
                                        echo '<option value="'.$dt['id_dosen'].'">'.$dt['id_dosen'].'-'.$dt['nama'].'</option>';
                                    }
                                ?>
                             </select>   
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix"></i><label>Pilih Tipe User</label><br/>
