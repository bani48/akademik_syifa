        ...
        die();
            ...
            if(isset($_REQUEST['submit'])){ 
                    $id_user = $_SESSION['admin'];  
                                    ...
                                    $path = "upload/"; 
                                 	$fileName 	= $_FILES['lampiran_pi']['name'];
                                	$tmpName 	= $_FILES['lampiran_pi']['tmp_name']; 
                                	$fileSize 	= $_FILES['lampiran_pi']['size']; 
                                	$fileType 	= $_FILES['lampiran_pi']['type'];
                                    ...
                                    $query = mysqli_query($config, "UPDATE seminar_praktek_industri SET
                                                                    id_pi='".$_POST['mahasiswa']."',
                                                                    lampiran_pi='".$fileName."',
                                                                    jurnal_pi='".$fileName2."',
                                                                    kartu_bimbingan='".$fileName3."', 
                                                                    modify_date='".date('Y-m-d H:i:S')."',
                                                                    modify_user='".$_REQUEST['create_user']."' o
                                                                    WHERE id='".$_REQUEST['id_pi']."'");
                                    if($query != false){
                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=daftar_pi&act=edit" class="judul"><i class="material-icons">bookmark</i>Edit Seminar Praktek Industri</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                <?php
                    ...
                    if(isset($_SESSION['errEmpty'])){
                      ...
                      $qry = mysqli_query($config, "SELECT * FROM seminar_praktek_industri WHERE id='".$_REQUEST['id_pi']."'");
                ...
                <div class="row jarak-form">
                    ...
                    <!-- Form START -->
                    <form class="col s12" method="post" action="?page=daftar_pi&act=upload_lampiran" enctype="multipart/form-data">
                        <table>
