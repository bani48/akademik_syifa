        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['submit'])){
                    ...
                    $id_user = $_SESSION['admin'];
                                ...
                                $cek = mysqli_query($config, "SELECT * FROM jadwal_seminar WHERE id_jadwal='$id_jadwal'");
                                ...
                                if($result > 0){
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO jadwal_seminar(id_jadwal,id_pi,tanggal,ruangan) VALUES('$id_jadwal','$id_pi','$tanggal','$ruangan')");
                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=jadwal&act=add" class="judul"><i class="material-icons">bookmark</i> Tambah Jadwal Seminar</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                <?php
                    ...
                    if(isset($_SESSION['errEmpty'])){
                      ...
                      $sql ="SELECT max(id_jadwal) as id_jadwal from jadwal_seminar";
                ...
                <div class="">
                    ...
                    <!-- Form START -->
                    <form class=" " method="post" action="?page=jadwal&act=add">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                     <select name="id_pi">
                                        <option></option>
                                        <?php
                                            $sql =mysqli_query($config,"SELECT praktek_industri.id_pi, mahasiswa.nama FROM praktek_industri
                                                                        INNER JOIN mahasiswa ON mahasiswa.nim=praktek_industri.nim");  
                                                    while($row = mysqli_fetch_array($sql))
                                                       {
                                                         echo "<option value='".$row['id_pi']."'>$row[nama]</option>"; 
                                                        }  
                                                     ?>
                                     </select> </td>
                            </tr> 
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="ruangan" id="ruangan"  class="validate" /></td>
                            </tr>
                            <tr>
                                <td colspan="2"><center>
                                    <div class="row">
