...
<head>
    ...
    <title>Sistem Informasi Praktek Industri dan Tugas Akhir dijurusan Teknik Elektro</title>
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Lupa Password ?</h5>
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                echo '<div class="upss red-text"><i class="material-icons">error_outline</i> <strong>ERROR!</strong> Username  dan Password Baru wajib diisi.
                               ...
                               $cek= mysqli_query($config, "SELECT username FROM tbl_user WHERE username=BINARY'$username' ");
                                if(mysqli_num_rows($cek) > 0){
                                    $query = mysqli_query($config, "UPDATE tbl_user SET password=MD5('$password') WHERE username='".$username."'");
                                    if($query == true){
                                        $_SESSION['succEdit'] = "Password Sudah diganti mohon untuk login kembali"; 
                                        header("Location: ./");
                                        die();
                                    } else {
                                    ...
                                    $_SESSION['errQ'] = 'ERROR! Username salah';
                                    echo '<script language="javascript">
                                            window.location.href="./lupa_password.php";
                                          </script>';  
                                }
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-light blue-grey col s12" name="submit">GANTI</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
