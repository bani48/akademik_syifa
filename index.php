                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Sistem Informasi Praktek Industri dan Tugas Akhir Pendidikan Teknik Elektro</h5>
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div >
                             <label ><a href="lupa_password.php">Lupa Password..?</a></label>
                        </div>
                        <div class="input-field col s12">
