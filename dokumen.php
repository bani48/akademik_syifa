                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=dokumen" class="judul"> dokumen</a></li>
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  echo '
                                        ...
                                        <td><a href="upload/'.$row['nama_dokumen'].'">'.$row['nama_dokumen'].'</a></td>
                                        ...
                                        <th width="18%">Opt </th>
                                            ...
                                            <div id="modal" class="modal">
                                                <div class="modal-content white">
                                                    ...
                                                    $query = mysqli_query($config, "SELECT * FROM dokumen");
                                                    list($id_sett,$dokumen) = mysqli_fetch_array($query);
                                                    echo '
                                                    <div class="row">
                                                        <form method="post" action="">
                                                            <div class="input-field col s12">
                                                                ...
                                                                <div class="input-field col s11 right" style="margin: -5px 0 20px;">
                                                                    <select class="browser-default validate" name="dokumen" required>
                                                                ...
                                                                <div class="modal-footer white">
                                                                    ...
                                                                    if(isset($_REQUEST['simpan'])){
                                                                        ...
                                                                        $query = mysqli_query($config, "UPDATE tbl_sett SET dokumen='$dokumen',id_user='$id_user' WHERE id_sett='$id_sett'");
                                                                        if($query == true){
